...
-- Sub-classification of interest (ICT specific roles with detailed Hong Kong-focused descriptions)
('Sub classification of interest', 'Architect', 'An IT Architect designs and oversees the overall structure of technology systems. They ensure systems meet business goals, are scalable, secure, and aligned with industry standards. In Hong Kong, they often work across finance, logistics, or government projects, bridging technical requirements with long-term strategy.'),
('Sub classification of interest', 'Business Analyst', 'Business Analysts act as the bridge between business needs and IT solutions. They gather requirements, analyze workflows, and propose improvements. In Hong Kong''s fast-paced industries, they play a key role in digital transformation and regulatory compliance.'),
('Sub classification of interest', 'Computer Operator', 'Computer Operators monitor and manage computer systems, ensuring smooth daily operations. Duties include running scheduled jobs, handling backups, and troubleshooting system alerts. In Hong Kong, this role is often vital in financial institutions and data centers requiring 24/7 system stability.'),
('Sub classification of interest', 'Consultant', 'IT Consultants provide expert advice to businesses on technology adoption, strategy, and problem-solving. They may specialize in cloud, cybersecurity, ERP systems, or digital transformation. In Hong Kong, consultants help organizations remain competitive and compliant with regional and international standards.'),
('Sub classification of interest', 'Database Development & Administration', 'Database professionals design, build, and manage databases to ensure efficient data storage, security, and availability. Administrators handle backups, performance tuning, and disaster recovery, while developers create queries and data models. In Hong Kong''s data-driven sectors, they are critical to banking and e-commerce systems.'),
('Sub classification of interest', 'Developer/Programmer', 'Developers write and maintain software applications, from web to mobile and enterprise systems. They use programming languages to create solutions tailored to business needs. In Hong Kong, developers support industries such as fintech, logistics, and smart city projects.'),
('Sub classification of interest', 'Engineering - Hardware', 'Hardware Engineers design, test, and maintain physical components like servers, storage devices, and embedded systems. In Hong Kong, they often work in telecommunications, electronics, and data center infrastructure.'),
('Sub classification of interest', 'Engineering - Network', 'Network Engineers build and maintain communication networks, including LAN, WAN, and cloud connectivity. They ensure high availability, performance, and security. In Hong Kong, they are key to supporting financial trading systems and large-scale enterprises.'),
('Sub classification of interest', 'Analyst Programmer', 'An Analyst Programmer combines programming with system analysis. They gather requirements, design solutions, and write code to meet user needs. In Hong Kong, they are often involved in banking systems, ERP, and government IT projects.'),
('Sub classification of interest', 'Help Desk & IT Support', 'Help Desk staff provide frontline IT assistance to users, resolving hardware, software, and network issues. They ensure smooth daily operations and escalate complex problems. In Hong Kong, they support both internal staff and external customers.'),
('Sub classification of interest', 'Management', 'IT Managers oversee teams, budgets, and project delivery. They align technology initiatives with business goals, ensuring efficient resource use. In Hong Kong, IT management often focuses on digital transformation, regulatory compliance, and regional coordination.'),
('Sub classification of interest', 'Networks & Systems Administration', 'System and Network Administrators maintain servers, operating systems, and networks. Their role includes patching, monitoring, and ensuring security. In Hong Kong''s finance-driven environment, uptime and compliance are crucial responsibilities.'),
('Sub classification of interest', 'Product Management', 'IT Product Managers oversee the lifecycle of technology products, from planning and development to launch and improvement. They balance market needs, technical feasibility, and business value. In Hong Kong, they drive fintech, SaaS, and consumer app innovations.'),
('Sub classification of interest', 'Data Analyst', 'Data Analysts collect, clean, and interpret data to generate insights that support decision-making. They build dashboards, reports, and models. In Hong Kong, they are in demand across banking, retail, and logistics for business intelligence.'),
('Sub classification of interest', 'Sales - Pre & Post', 'Pre-sales engineers work with clients to understand needs and propose IT solutions, while post-sales staff ensure smooth deployment and customer satisfaction. In Hong Kong, these roles are vital for enterprise IT vendors and service providers.'),
('Sub classification of interest', 'Security', 'IT Security professionals protect systems and data from cyber threats. They implement firewalls, monitor incidents, conduct penetration tests, and ensure compliance. In Hong Kong, with strict data regulations, security is a top priority in finance and government.'),
('Sub classification of interest', 'Team Leaders', 'IT Team Leaders supervise small teams, assign tasks, and ensure projects stay on track. They bridge communication between management and technical staff. In Hong Kong, they often oversee developers, support staff, or system engineers.'),
('Sub classification of interest', 'Technical Writing', 'Technical Writers create manuals, guides, and documentation for software, hardware, and systems. They make complex IT concepts accessible to users. In Hong Kong, they often serve regional teams requiring bilingual materials.'),
('Sub classification of interest', 'Telecommunications', 'Telecom Engineers manage voice, video, and data communication systems. They work with technologies like VoIP, 5G, and satellite systems. In Hong Kong, they support carriers, enterprises, and smart city infrastructure.'),
('Sub classification of interest', 'Quality Assurance', 'QA specialists test software and systems to ensure they meet standards and function correctly. They design test cases, find bugs, and verify fixes. In Hong Kong, QA is essential in fintech and mission-critical applications.'),
('Sub classification of interest', 'Systems Analyst', 'Systems Analysts evaluate business processes and design IT systems to improve efficiency. They prepare functional specifications, work with developers, and support implementation. In Hong Kong, they are crucial in financial and government IT modernization.'),
('Sub classification of interest', 'AI Engineer', 'AI Engineers develop and deploy machine learning models and AI systems. They work on natural language processing, computer vision, and automation solutions. In Hong Kong, AI engineers contribute to fintech innovation, smart city projects, and research.'),
